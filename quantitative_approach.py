...
def main():
    ...
    # OUTPUTS REQUIRED
    equity_curve.to_csv("./performance_stats/quantitative_performance/equity_curve.csv",index=False)
    trade_log.to_csv("./performance_stats/quantitative_performance/trade_log.csv",index=False)
    full_df[["Date","Drawdown"]].to_csv("./performance_stats/quantitative_performance/drawdown_curve.csv",index=False)

    # Export metrics
    pd.DataFrame(metrics, index=[0]).to_csv("./performance_stats/quantitative_performance/performance_metrics.csv", index=False)
    ...
    rolling_table.to_csv("./performance_stats/quantitative_performance/rolling_outperformance.csv", index=False)

    # Export turnover
    pd.DataFrame({"Turnover":[turnover]}).to_csv("./performance_stats/quantitative_performance/turnover.csv", index=False)
